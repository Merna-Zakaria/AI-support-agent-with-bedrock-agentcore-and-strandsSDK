...
# Steps: call `browser` with action init_session (session_name "main"), then navigate to
# the URL, then read the page with get_text (or evaluate "document.title" for the title),
# then close the session. If init_session says the session already exists, continue with
# navigate.
...
#     """Small models sometimes send a JSON string, or the action fields without the 'action' wrapper."""
...
#             {"action": {"type": "init_session", "session_name": "main", "description": "research"}}
#             {"action": {"type": "navigate", "session_name": "main", "url": "https://example.com"}}
#             {"action": {"type": "evaluate", "session_name": "main", "script": "document.title"}}
#             {"action": {"type": "get_text", "session_name": "main", "selector": "body"}}
#             {"action": {"type": "close", "session_name": "main"}}
...
#     steps = [
#         {"action": {"type": "init_session", "session_name": "diag", "description": "diagnostic"}},
#         {"action": {"type": "navigate", "session_name": "diag", "url": "https://example.com"}},
#         {"action": {"type": "get_text", "session_name": "diag", "selector": "h1"}},
#     ]
#     report: Dict[str, str] = {}
#     try:
#         for step in steps:
...
#             browser_wrapper({"action": {"type": "close", "session_name": "diag"}}), 300)
#     return report
